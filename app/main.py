...
from app.api.routes import ilustracoes  # ILUSTRACOES (pictogramas ARASAAC + IA)
from app.api.routes import estrategias_adaptacao  # Biblioteca de Estrategias de Adaptacao
from app.api.routes import student_ilustracoes  # ILUSTRACOES no portal do aluno (read-only)
...
app.include_router(estrategias_adaptacao.router, prefix="/api/v1", tags=["📚 Estratégias de Adaptação"])
